...
export default function ReincidenciaView() {
    ...
    const columns = [
        { key: "equipo", header: "Equipo", render: (row) => <span className="font-mono font-semibold text-slate-900">{row.equipo}</span> },
        ...
        { key: "visitas", header: "Visitas", align: "right", render: (row) => <span className="font-mono">{row.visitas}</span> },
        {
            ...
            render: (row) => (
                <span
                    className={`font-mono ${
                        row.reincMax >= 4 ? "font-bold text-rose-600" : "text-amber-600"
                    }`}
                >
                    {row.reincMax}
                </span>
        ...
        >
            ...
            {r.equipoMasCritico && (
                <div
                    id="alert-box"
                    role="alert"
                    className="rounded-[14px] border-l-4 border-rose-600 bg-rose-50 p-4 shadow-sm sm:p-5"
                >
