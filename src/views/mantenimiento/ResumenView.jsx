...
function ChartCard({ title, children, className = "" }) {
    return (
        <article
            className={`rounded-[14px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.10)] sm:p-6 dark:border-white/10 dark:bg-carbon-900 ${className}`}
        >
            <h2 className="text-[1.05rem] font-bold text-slate-900 dark:text-slate-100">{title}</h2>
