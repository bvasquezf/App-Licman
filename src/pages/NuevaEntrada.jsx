        ...
        <div className="space-y-4">
          <Card>
            ...
            <p className="mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
              Las entradas suman unidades al stock. Usá este formulario para
              compras a proveedores, conteos iniciales, devoluciones o ajustes
              de inventario.
            </p>
          </Card>
          ...
          <Card>
            ...
            <ul className="mt-2 space-y-1.5 text-xs text-slate-500 dark:text-slate-400">
              ...
              <li>
                ...
                — para cargar el conteo al implementar el sistema.
              </li>
              <li>
                <span className="font-medium text-slate-700 dark:text-slate-200">
                  Ajuste positivo
