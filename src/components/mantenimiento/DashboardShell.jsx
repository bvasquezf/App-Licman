...
export default function DashboardShell({ title, subtitle, children }) {
    ...
    return (
        <section className="space-y-4">
            <header>
                <h1 className="text-[1.35rem] font-bold text-slate-900 dark:text-slate-100">{title}</h1>
                {subtitle && (
            ...
            {loading && rawData.length === 0 && (
                <div className="rounded-[14px] border border-slate-200 bg-white p-8 text-center shadow-[0_10px_30px_rgba(15,23,42,0.10)] dark:border-white/10 dark:bg-carbon-900">
                    <div className="mx-auto h-10 w-10 animate-spin rounded-full border-4 border-slate-200 border-t-blue-600 dark:border-white/10 dark:border-t-blue-500" />
            ...
            {!loading && loadError && sinDatos && (
                <div className="rounded-[14px] border-l-4 border-rose-600 bg-rose-50 p-5 text-rose-900 shadow-sm dark:bg-rose-500/10 dark:text-rose-300">
            ...
            {sinCoincidencias && (
                <div className="rounded-[14px] border-2 border-dashed border-slate-300 bg-white p-8 text-center dark:border-white/15 dark:bg-carbon-900">
