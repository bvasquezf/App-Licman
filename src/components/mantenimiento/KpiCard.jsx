...
export default function KpiCard({ title, value, sub, accent = "blue" }) {
    ...
    return (
        <div className="relative overflow-hidden rounded-[14px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.10)] dark:border-white/10 dark:bg-carbon-900">
            <div
