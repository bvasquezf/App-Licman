    ...
    return (
        <div className="mb-5 flex flex-col gap-3 sm:mb-6 md:mb-8 md:flex-row md:items-start md:justify-between md:gap-4">
            <div className="flex min-w-0 items-start gap-3">
                {icon && (
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] bg-brand-100 text-xl ring-1 ring-brand-200/60 dark:bg-brand-500/15 dark:ring-brand-500/30 sm:h-11 sm:w-11 sm:text-2xl">
                        {icon}
                    </div>
                )}
                <div className="min-w-0 flex-1">
                    ...
                    {subtitle && (
                        <p className="mt-0.5 text-xs text-slate-500 dark:text-neutral-400 sm:mt-1 sm:text-sm">
                            {subtitle}
                        </p>
                    )}
                </div>
